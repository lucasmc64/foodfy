...
class PageController {
    ...
    recipies(request, response) { //Rota
    ...
    recipie(request, response) { //Rota
        const id = request.params.id
        
        const food = data.find((receita) => receita.id == id)
    
        return response.render('recipie', { data: food }) //Renderiza a página
    }
}
